  ...
  <div class="container">
              <div class="schedule-text">
                  ...
                  <div class="st-table">
                      ...
                      @if($statut=="participant" && $participer=="Oui")
                      <a href="{{url('participation')}}?id={{$tournoi->idtournoi}}" type="button" class="btn btn-primary">Participer</a>
                      @endif
                    </div>
              </div>
  </div>
