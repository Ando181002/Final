                    ...
                    <div class="card-body">
                        ...
                        <div class="tab-content pt-2">  
                            ...
                            <div class="tab-pane fade profile-edit pt-3" id="profile-edit">
                                <form action="/FicheTournoi/updateTournoi" class="row g-3" method="POST">
                                    ...
                                    <div class="col-12">
                                        ...
                                        <input type="text" name="description" class="form-control" id="description" style="height: 100px" value="{{$fichetournoi->description}}">
                                    </div>
                                    <div class="col-12">
                                        <label for="inputAddress" class="form-label">Répartition cagnote</label>
                                        <div class="row">
                                          <div class="col-md-2">
                                            <input type="text" class="form-control"  placeholder="1er" name="rang1" value="{{$cagnote->rang1}}">
                                          </div>
                                          <div class="col-md-2">
                                            <input type="text" class="form-control"  placeholder="2eme" name="rang2" value="{{$cagnote->rang2}}">
                                          </div>
                                          <div class="col-md-2">
                                            <input type="text" class="form-control"  placeholder="3eme" name="rang3" value="{{$cagnote->rang3}}">
                                          </div>
                                          <div class="col-md-2">
                                            <input type="text" class="form-control"  placeholder="4eme" name="rang4" value="{{$cagnote->rang4}}">
                                          </div>
                                          <div class="col-md-2">
                                            <input type="text" class="form-control"  placeholder="5eme" name="rang5" value="{{$cagnote->rang5}}">
                                          </div>
                                        </div>            
                                      </div>
                            ...
                            <div class="tab-pane fade pt-3" id="participant">
                                <nav>
                                    <p class="breadcrumb-item">Actuellement <span class="card-title">{{count($participant)}} paticipants</span></p>
                                </nav>
                                <nav>
                                    <?php $cagnote=count($participant)*$fichetournoi->frais; ?>
                                    <p class="breadcrumb-item">Cagnote <span class="card-title">{{$cagnote}} Ar</span></p>
                                </nav>
                                <table class="table">
                                    <thead>
                                      <tr>
