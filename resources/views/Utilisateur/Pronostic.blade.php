        ...
        <div class="container py-5">
            ...
            <div class="pagetitle">
                ...
                <nav>
                  ...
                  ?>
                    <p class="breadcrumb-item">Vous avez actuellement <span class="card-title">{{$total}} points</span></p>
                </nav>
            </div><!-- End Page Title -->
             <!-- Recent Sales -->
             <div class="col-12">
      ...
      <!-- Schedule Section End -->
                    ...
                    <table class="table">
                        ...
                        <tbody>
                            <?php for ($i=1; $i <=5 ; $i++) { 
                                $rang="rang".$i;
                                $pourcentage=$cagnote->$rang*100;
                                $montant=$montantCagnote*$cagnote->$rang;
                                ?>
                            <tr>
                                <th scope="row">{{$i}}</th>
                                <td>{{$pourcentage}}%</td>
